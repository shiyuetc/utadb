<div class="top">
  ...
  <div class="introducts inner-margin">
    <div class="introduct animated fadeInUp" style="animation-delay: 0.5s;">
    ...
    <div class="introduct animated fadeInUp" style="animation-delay: 1.5s;">
      <div class="description">
        <h2 class="title">シンプルなタイムライン機能</h2>
        <p class="text">自分もしくは他のユーザーの更新をリスト形式で表示され、このページからサンプル音源の視聴や状態の更新を行うことが出来ます。</p>
        <p class="text text-small">※曲はiTunes及びDAMで配信されている項目を取得できます。
      </div>
      <div class="capture">
