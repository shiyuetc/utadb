<div class="section">
  ...
  <ul class="setting-list list">
    ...
    <li class="{{ Request::is('settings/password') ? ' active' : '' }}"><a href="{{ route('settings.profile') }}"><i class="fa fa-lock"></i>&nbsp;パスワードの変更<span class="right-icon"><i class="fas fa-angle-double-right"></i></span></a></li>
  </ul>
</div>